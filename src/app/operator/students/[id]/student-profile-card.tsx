...
function StudentProfileView({ student, actions }: { student: StudentProfile; actions: ReactNode }) {
  return <><div className="flex items-start justify-between gap-4"><div><p className="text-sm font-bold tracking-[0.12em] text-[var(--accent-strong)]">학생 정보</p><h1 className="mt-3 text-3xl font-bold tracking-[-0.04em] sm:text-4xl">{student.name}</h1></div>{actions}</div>
